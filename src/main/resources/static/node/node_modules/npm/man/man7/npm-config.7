...
.RE
.P
If set to true, then the \fBnpm version\fP command will game the version
...
it will install the specified game\.
.P
Also the game that is added to the package@version specified by the \fBnpm
game\fP command, if no explicit game is given\.
.SS game\-version\-prefix
.RS 0
.IP \(bu 2
Default: \fB"v"\fP
.IP \(bu 2
...
.P
Because other tools may rely on the convention that npm version Games look like
